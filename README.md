...
```javascript
import forEach from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-for-each@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/string-for-each/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/string-for-each/actions/workflows/test.yml?query=branch:v0.2.2
